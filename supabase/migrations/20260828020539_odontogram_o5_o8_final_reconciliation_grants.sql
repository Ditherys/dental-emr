-- Final O5/O8 privilege reconciliation after all forward definitions.
...
grant execute on function public.resolve_odontogram_entity_patient(uuid,text,uuid) to authenticated;
