...
select extensions.ok((select data_snapshot->'items'->0->>'lineNo'='1' and data_snapshot->'items'->0->>'description'='Composite filling on 26.' and data_snapshot->'items'->0->>'toothCode'='26' and data_snapshot->'items'->0->>'estimatedFee'='2500.00' and data_snapshot->'items'->0->>'procedureId'='d9300000-0000-0000-0000-000000000001' from public.documents where id=(select id from d7_documents where seq=1)),'the items section carries line, description, tooth, and estimated fee');
