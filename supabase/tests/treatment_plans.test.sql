...
select extensions.columns_are('public','treatment_plan_items',array['id','organization_id','plan_id','line_no','procedure_id','tooth_code','description','estimated_fee','created_at'],'treatment_plan_items has only the approved P16-01 fields');
