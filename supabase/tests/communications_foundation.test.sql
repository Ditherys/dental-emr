...
select extensions.columns_are('public','communications',array['id','organization_id','branch_id','patient_id','appointment_id','channel','template_type','recipient','subject','body','provider_id','provider_message_id','status','idempotency_key','attempts','max_attempts','next_attempt_at','scheduled_for','sent_at','delivered_at','failed_at','cancelled_at','created_at','updated_at','version'],'communications has only the approved P8-02 fields plus the P8-03 optimistic version column');
