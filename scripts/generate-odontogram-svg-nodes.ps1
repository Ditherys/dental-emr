...
[void]$out.AppendLine('// copyright and permission notice is preserved in THIRD_PARTY_NOTICES.md and')
[void]$out.AppendLine('// vendor/react-advanced-odontogram/LICENSE.')
[void]$out.AppendLine('//')
